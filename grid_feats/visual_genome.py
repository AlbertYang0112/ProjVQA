...
_PREDEFINED_SPLITS_VG = {
    "visual_genome_train": ("vg/images", 
                            "vg/annotations/visual_genome_train.json"),
    "visual_genome_val": ("vg/images", 
                          "vg/annotations/visual_genome_val.json"),
    "visual_genome_test": ("vg/images", 
                           "vg/annotations/visual_genome_test.json"),
}
